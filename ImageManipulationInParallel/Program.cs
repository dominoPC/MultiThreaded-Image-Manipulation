...
namespace ImageManipulationInParallel
{
    class Program
    {
        ...
        private static long DoInParallel()
        {
            ...
            Rectangle rectangle04 = new Rectangle(0, heightOneFourth *3, bitmap.Width, height - heightOneFourth*3);
            ...
            Bitmap bitmap04 = new Bitmap(width, rectangle04.Height);
            ...
            Rectangle targetRectangle04 = new Rectangle(0, heightOneFourth*3, bitmap01.Width, bitmap04.Height);
